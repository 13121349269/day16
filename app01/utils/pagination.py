...
class Pagination(object):
    ...
    def html(self):
        ...
        if self.page < self.total_page_count:
            ...
            prev = '<li><a href="?page={}"></a>下一页</li>'.format(self.total_page_count)
        page_str_list.append(prev)
        ...
        <li>
            <form style="float: left;margin-left; -1px" method="get">
                    <input name="page" type="text" style="position: relative;float:left;display:inline-block;
                    width: 80px;border-radius: 0;" class="form-control" placeholder="页码">
